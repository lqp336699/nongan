		...
		<u--form :model="formData" ref="form" :rules="rules" errorType="toast">
			...
			<view class="bgWhite  br20 mb10">
				<view :class="['flex',  'flex-between,px30', 'align-center']" :key="ny_name">
					<u-form-item class="flex1" :labelWidth="190" label="农药名称" prop="ny_name">
						<u-input border="false" input-align="right" placeholder-style="text-align:right"
							placeholder="请输入农药名称" v-model="formData.ny_name" />
					</u-form-item>
				</view>
			</view>

			<view class="bgWhite  br20 mb10">
				<view :class="['flex',  'flex-between,px30', 'align-center']" :key="fz_object">
					<u-form-item class="flex1" :labelWidth="190" label="防治对象" prop="fz_object">
						<u-input border="false" input-align="right" placeholder-style="text-align:right"
							placeholder="请输入防治对象" v-model="formData.fz_object" />
					</u-form-item>
				</view>
			</view>
			...
			<view class="bgWhite  br20 mb10">
				<view :class="['flex',  'flex-between,px30', 'align-center']" :key="sy_method">
					<u-form-item class="flex1" :labelWidth="190" label="施用方法" prop="sy_method">
						<u-input border="false" input-align="right" placeholder-style="text-align:right"
							placeholder="请输入施用方法" v-model="formData.sy_method" />
					</u-form-item>
				</view>
			</view>

			<view class="bgWhite  br20 mb10">
				<view :class="['flex',  'flex-between,px30', 'align-center']" :key="aq_time">
					<u-form-item class="flex1" :labelWidth="190" label="安全间隔期" prop="aq_time">
						<u-input border="false" input-align="right" placeholder-style="text-align:right"
							placeholder="请输入安全间隔期" v-model="formData.aq_time" />
					</u-form-item>
				</view>
			</view>

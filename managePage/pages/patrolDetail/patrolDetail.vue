			...
			<view class="relactive mt40 px24 border-box">
				...
				<view class="br10 px24 py36 border-box" style="background: #F5FFFB;">
					...
					<view class="flex flex-wrap">
						<view class=" flex flex-center align-center" v-for="item in 6" :key="item"
							style="margin: 6rpx;">
							<image style="height:206rpx; width:206rpx;" class="br16" src="/static/logo.png" mode="">
							</image>
						</view>
					</view>
				</view>
				...
				<view class="mt20 px30 py40 border-box bgWhite flex flex-column flex-between ">
					...
					<view class="flex flex-between align-center py30  border-box" v-for="(item,index) in 4"
						:key="index">
